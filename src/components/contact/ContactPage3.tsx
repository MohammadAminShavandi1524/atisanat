  ...
  return (
    ...
    >
      <section className="w90 py-24">
        ...
        {/* Main Contact Box */}
        <div className="border-border grid grid-cols-[0.72fr_1.28fr] overflow-hidden rounded-xl border">
          {/* Contact Information */}
          <motion.aside
            initial={{
              opacity: 0,
            ...
            className="bg-secondary-bg min-w-0 p-10"
          >
          ...
          <motion.div
            ...
            className="border-border min-w-0 border-s p-10"
          >
            <h2 className="text-foreground text-[28px] font-semibold">
              {t("form.title")}
            </h2>
